...
export const getSlides = (idioma) => {
  const slides = [
...

    {
      ...
      model: <Cofre scale={0.1} position={[0, 0, 0]} />,
    },
...
export const informacionSlider = (idioma) => {
  const beneficios = [
    {
      icon: <TbRulerMeasure size={60} />,
      texto:
        idioma === "es"
          ...
          : "We take precise measurements of the space where the awning will be installed, ensuring a perfect fit and a seamless installation.",
      imagen: "/assets/Imagenes/fondo-beneficios.jpg",
      portada: idioma === "es" ? "Medición del espacio" : "Space measurement",
    },
    {
      ...
      imagen: "/assets/Imagenes/toldo3.jpg",
      portada: idioma === "es" ? "Diseño de toldos" : "Awning design",
    },
    {
      ...
      portada:
        idioma === "es" ? "Fabricación de toldos" : "Awning manufacturing",
    },
    {
      icon: <GrUserWorker size={60} />,
      texto:
        idioma === "es"
          ? "Nuestro equipo altamente cualificado instala el toldo asegurando su correcta fijación y funcionalidad, garantizando un trabajo profesional adaptado a cada proyecto."
          : "Our highly qualified team installs the awning, ensuring proper fixation and functionality, guaranteeing a professional job adapted to each project.",
      imagen: "/assets/Imagenes/fondoo.png",
      portada:
        idioma === "es" ? "Instalación de toldos" : "Awning installation",
    },
  ];
...
export const informacionBoton = (idioma, id) => {
  ...
  console.log(boton);  // Agrega un console.log para depurar

  // Si el botón existe, devuelve el texto en el idioma seleccionado
  return boton
    ? { id: boton.id, texto: boton.texto[idioma] || boton.texto.es, url: boton.url }
    : null;
};
