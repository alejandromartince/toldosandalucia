export const infoHistoria = {
  es: {
    ...
    titulosubcontenido:
      "Actualmente, <strong>trabajamos en</strong> un amplio radio que abarca las siguientes áreas: ",
    subcontenido:
  ...
  en: {
    ...
    titulosubcontenido:
      "Currently, <strong>we operate within a wide area</strong> that covers the following locations: ",
    subcontenido:
      "We manufacture and install awnings for all types of spaces: residential communities, private homes, hospitality businesses, bars, restaurants, and hotels, always adapting to the specific needs of each client.",
  },
};
