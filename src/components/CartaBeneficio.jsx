...
import './CartaBeneficio.css'; // Asegúrate de tener los estilos en el archivo Card.css

const CartaBeneficio = () => {
  return (
    <div className="card">
      <div className="content">
        <div className="back">
          <div className="back-content">
            ...
            <strong>Nombre de ventaja</strong>
          </div>
        </div>
        <div className="front">
          <div className="img">
