...
const CasaProducto = (props) => {
  const { nodes, materials } = useGLTF('/models/Productos.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Volumen_Suelo.geometry}
        material={materials['Material.001']}
        position={[-1.696, -0.111, -0.449]}
        scale={[6.501, 0.104, 6.283]}
      />
    </group>
  )
}

useGLTF.preload('/models/Productos.glb')
export default CasaProducto